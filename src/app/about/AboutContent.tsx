    ...
    <div>
      <header className="page">
        ...
        <p className="page__lead">
          StackLab — это маленькая команда, где вы говорите напрямую с теми, кто
          принимает архитектурные решения и пишет продакшн-код. Никаких
          менеджеров-посредников, только инженеры, продукты и запуски.
        </p>
      </header>
