...
const TEXT_HTML = `Мы не агентство. Не интегратор. Не конвейер лендингов. StackLab — это <em>маленькая</em> инженерная студия, в которой вы говорите напрямую с теми, кто принимает архитектурные решения и пишет <em>продакшн-код</em>. Никаких менеджеров-посредников. Только инженеры, продукты и запуски.`;
