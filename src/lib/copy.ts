...
export const PRO_COPY: SiteCopy = {
  ...
  about: {
    ...
    cells: [
      ...
      { k: 'К · 02', vMain: '0', vEm: 'подрядчиков', p: 'Все слои стека — внутри команды: iOS, MAX, веб, backend, инфраструктура.' },
...
export const DEV_COPY: SiteCopy = {
  ...
  about: {
    ...
    cells: [
      ...
      { k: 'К · 02', vMain: '0', vEm: 'подрядчиков', p: 'Весь стек закрываем внутри команды: iOS, MAX, веб, backend, инфраструктура. Без субподряда.' },
